...
awful.util.tagnames = { "www", "sys", "file", "kodi", "game", "doc" }
...
globalkeys = my_table.join(
    ...
    --aw234ful.key({ modkey }, "F12", function () awful.util.spawn( "rofi -show run" ) end,
    ...
    awful.key({ modkey }, "p", function () awful.util.spawn( "psensor") end,
        {description = "run psensor", group = "super"}),
    ...
    -- alt + ...
     ...
     awful.key({ altkey, "Shift"   }, "u", function () awful.spawn.with_shell( "wal -s -n -i $(cat $HOME/.config/variety/wallpaper/wallpaper.jpg.txt)&" ) end,
...
awful.rules.rules = {
    ...
    -- All browsers open to screen 1, tag 1
    ...
    -- File managers open to screen 1, tag 3
    { rule = { class = "Thunar" },
...
awful.spawn.with_shell("picom --experimental-backends -f -b --config  $HOME/.config/awesome/picom.conf")
