...
#Show AMD GPU Clocks and Voltages
alias showclk="watch -n 0.5  sudo cat /sys/kernel/debug/dri/0/amdgpu_pm_info"

#Turn picom ON
alias picomon="picom --experimental-backends -f -b --config  $HOME/.config/awesome/picom.conf"

#Kill picom
alias picomoff="killall picom"


#Launch Opentrack and set camera settings
alias ot="v4l2-ctl -c white_balance_automatic=0,auto_exposure=1 && v4l2-ctl -c exposure=1 && /home/htpc/Downloads/opentrack/build/install/bin/opentrack"
